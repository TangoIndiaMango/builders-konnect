...
import { Button, Input, Select, Form, Divider, Checkbox, Radio } from 'antd';
import { ArrowLeftOutlined, ShopOutlined, TruckOutlined } from '@ant-design/icons';
      ...
      <div className="flex bg-[#F9F9F9]   flex-col xl:flex-row min-h-screen">
        <div className="w-full xl:w-[60%]  bg-white px-6 xl:px-24 py-16">
          ...
          <Form layout="vertical">
            ...
            <h3 className="font-semibold text-base mb-3">Shipping Address</h3>
