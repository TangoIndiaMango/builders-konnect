...
export default function ProfileCard() {
  return (
    <Card className="w-full max-w-sm mx-auto p-0 overflow-hidden rounded-lg border-0 shadow-none">
      {/* Profile Section */}
      <div className="flex flex-col items-center py-4 px-4 sm:px-6">
        ...
        <h4 className="text-sm sm:text-base font-semibold mb-0 text-center">Olugbenga Daniels</h4>
        <p className="text-xs sm:text-sm text-gray-500 mb-1 text-center break-all">
          daniels@buildershub.com
        </p>
        <div className="bg-gray-100 rounded-full px-3 py-0.5 text-xs sm:text-sm">
