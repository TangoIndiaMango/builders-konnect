    ...
    <div className="h-full">
      <div className="flex justify-between items-center bg-white mb-2 p-6">
        <div>
          ...
          <p className="text-gray-500 text-sm">Add products, track product performance and inventory here</p>
        </div>
        ...
        <div className="flex items-center gap-5">
            <Button
              className="rounded"
              size="large"
              onClick={() => navigate('/pos/products-inventory/inventories')}
            >
              View Inventory
            </Button>

            <Button type="primary" className="rounded" size="large" icon={<PlusOutlined />} >
          Add Product
        </Button>
          </div>
...
<div className="space-y-3 bg-white p-10">
      ...
      <Divider />
      {
      productData.length === 0 ? <EmptyInventoryState /> : 
